...
## ソースコードの説明
l.114~116 while文を使い、visitedを初期化
l.119 Stackを初期化
l.120 出発点をPush
l.121 スタックが空になるまで繰り返す(while)
l.122 スタックから１つ取り出す
l.123 行ったことがあるか確認(if)
l.124 無ければ行ったことにする。
l.125~127 またその場所から行ける場所をスタックに入れる
l.135~139 その場所に行った場合〇は通ったを出力

l.214~216 while文を使い、visitedを初期化
l.218 キューを初期化
l.219 出発点をPush
l.221 キューが空になるまで繰り返す(while)
l.222 キューから１つ取り出す
l.223 行ったことがあるか確認(if)
l.224 無ければ行ったことにする。
l.225 toを0にする。
l.226~228 またその場所から行ける場所をキューに入れる
l.235~238 その場所に行った場合〇は通ったを出力
