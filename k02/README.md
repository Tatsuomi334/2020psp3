...
## ソースコードの説明
l.80 新しい要素のデータ領域の確保
l.81 newnodeというリストのcityの領域にnewcityを代入
l.82 newnodeというリストのpNextの領域にpNextを代入
l.83 newnodeを返す
l.108~110 リストの先頭から順番に要素を辿っていく準備
l.111 アドレスがなくなるまで以下のことを繰り返す
l.112 探しているIDとpListというリストのcityの中のidと一致したら
l.113 *pCityにIDを代入
l.114  iを返す
l.116 次の要素に移動
l.117 iに１をたす。
l.120 IDがヒットしなかったら-1を返す。
